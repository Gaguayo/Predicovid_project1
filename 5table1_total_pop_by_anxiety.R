...
# Sex
(totall<-table(newlongc40$sexm)[[1]])
(perall<-round(100*prop.table(table(newlongc40$sexm)))[[1]])

(totanx<-table(newlongc40$sexm[newlongc40$medanx=="yes"])[[1]])
(peranx<-round(100*prop.table(table(newlongc40$sexm[newlongc40$medanx=="yes"])))[[1]])

(totnoanx<-table(newlongc40$sexm[newlongc40$medanx=="no"])[[1]])
(pernoanx<-round(100*prop.table(table(newlongc40$sexm[newlongc40$medanx=="no"])))[[1]])


(p<-chisq.test(newlongc40$sexm,newlongc40$medanx))
(pvalue<-p$p.value)

x<-c("women",totall,perall,totanx,peranx,totnoanx,pernoanx,pvalue)
sex<-data.frame(x)
sext<-t(sex)
sext<-data.frame(sext)
names(sext)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
               "pvalue")
...
(totanx<-round(mean(newlongc40$age_estimateyears[newlongc40$medanx=="yes"]),1))
(peranx<-round(sd(newlongc40$age_estimateyears[newlongc40$medanx=="yes"]),1))

(totnoanx<-round(mean(newlongc40$age_estimateyears[newlongc40$medanx=="no"]),1))
(pernoanx<-round(sd(newlongc40$age_estimateyears[newlongc40$medanx=="no"]),1))
...
names(aget)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
               "pvalue")
...
(totanx<-round(mean(newlongc40$bmi[newlongc40$medanx=="yes"]),1))
(peranx<-round(sd(newlongc40$bmi[newlongc40$medanx=="yes"]),1))

(totnoanx<-round(mean(newlongc40$bmi[newlongc40$medanx=="no"]),1))
(pernoanx<-round(sd(newlongc40$bmi[newlongc40$medanx=="no"]),1))
...
names(bmit)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
               "pvalue")
...
(totanx<-round(mean(newlongc40$sum_all_activities[newlongc40$medanx=="yes"]),1))
(peranx<-round(sd(newlongc40$sum_all_activities[newlongc40$medanx=="yes"]),1))

(totnoanx<-round(mean(newlongc40$sum_all_activities[newlongc40$medanx=="no"]),1))
(pernoanx<-round(sd(newlongc40$sum_all_activities[newlongc40$medanx=="no"]),1))
...
names(phactivityt)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
               "pvalue")
...
(totanx<-table(newlongc40$younger[newlongc40$medanx=="yes"])[[1]])
(peranx<-round(100*prop.table(table(newlongc40$younger[newlongc40$medanx=="yes"])))[[1]])


(p<-chisq.test(newlongc40$younger,newlongc40$medanx))
(pvalue<-p$p.value)
...
names(youngert)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
                   "pvalue")


all<-rbind(sext,youngert)
...
(totanx<-table(newlongc40$older[newlongc40$medanx=="yes"])[[2]])
(peranx<-round(100*prop.table(table(newlongc40$older[newlongc40$medanx=="yes"])))[[2]])

(totnoanx<-table(newlongc40$older[newlongc40$medanx=="no"])[[2]])
(pernoanx<-round(100*prop.table(table(newlongc40$older[newlongc40$medanx=="no"])))[[2]])

(p<-chisq.test(newlongc40$older,newlongc40$medanx))
(pvalue<-p$p.value)
...
names(oldert)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
                 "pvalue")

all<-rbind(sext,youngert, oldert)
...
totanx<-table(newlongc40$loweduc[newlongc40$medanx=="yes"])[[1]]
peranx<-round(100*prop.table(table(newlongc40$loweduc[newlongc40$medanx=="yes"])))[[1]]

totnoanx<-table(newlongc40$loweduc[newlongc40$medanx=="no"])[[1]]
pernoanx<-round(100*prop.table(table(newlongc40$loweduc[newlongc40$medanx=="no"])))[[1]]
...
names(low_educationt)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
                         "pvalue")

all<-rbind(sext,youngert, oldert,low_educationt)
...
lowinc<-newlongc40$income[newlongc40$income==1]
table(newlongc40$income)
round(100*prop.table(table(newlongc40$income)),1)

(totall<-table(newlongc40$lowincome)[[2]])
(perall<-round(100*prop.table(table(newlongc40$lowincome)))[[2]])

(totanx<-table(newlongc40$lowincome[newlongc40$medanx=="yes"])[[2]])
(peranx<-round(100*prop.table(table(newlongc40$lowincome[newlongc40$medanx=="yes"])))[[2]])

(totnoanx<-table(newlongc40$lowincome[newlongc40$medanx=="no"])[[2]])
(pernoanx<-round(100*prop.table(table(newlongc40$lowincome[newlongc40$medanx=="no"])))[[2]])
...
names(low_incomet)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
                      "pvalue")

all<-rbind(sext,youngert, oldert,low_educationt,low_incomet)
...
totanx<-table(newlongc40$work[newlongc40$medanx=="yes"])[[1]]
peranx<-round(100*prop.table(table(newlongc40$work[newlongc40$medanx=="yes"])))[[1]]

totnoanx<-table(newlongc40$work[newlongc40$medanx=="no"])[[1]]
pernoanx<-round(100*prop.table(table(newlongc40$work[newlongc40$medanx=="no"])))[[1]]
...
names(no_workt)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
                   "pvalue")

all<-rbind(sext,youngert, oldert,low_educationt,low_incomet,no_workt)
...
totanx<-table(newlongc40$owner[newlongc40$medanx=="yes"])[[1]]
peranx<-round(100*prop.table(table(newlongc40$owner[newlongc40$medanx=="yes"])))[[1]]

totnoanx<-table(newlongc40$owner[newlongc40$medanx=="no"])[[1]]
pernoanx<-round(100*prop.table(table(newlongc40$owner[newlongc40$medanx=="no"])))[[1]]
...
names(no_ownert)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
                    "pvalue")

all<-rbind(sext,youngert, oldert,low_educationt,low_incomet,no_workt, no_ownert)
...
totanx<-table(newlongc40$obese[newlongc40$medanx=="yes"])[[2]]
peranx<-round(100*prop.table(table(newlongc40$obese[newlongc40$medanx=="yes"])))[[2]]

totnoanx<-table(newlongc40$obese[newlongc40$medanx=="no"])[[2]]
pernoanx<-round(100*prop.table(table(newlongc40$obese[newlongc40$medanx=="no"])))[[2]]
...
names(obeset)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
                 "pvalue")

all<-rbind(sext,youngert, oldert,low_educationt,low_incomet,no_workt, no_ownert, obeset)
...
totanx<-table(newlongc40$underweight[newlongc40$medanx=="yes"])[[2]]
peranx<-round(100*prop.table(table(newlongc40$underweight[newlongc40$medanx=="yes"])))[[2]]

totnoanx<-table(newlongc40$underweight[newlongc40$medanx=="no"])[[2]]
pernoanx<-round(100*prop.table(table(newlongc40$underweight[newlongc40$medanx=="no"])))[[2]]
...
names(underweightt)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
                       "pvalue")

all<-rbind(sext,youngert, oldert,low_educationt,low_incomet,no_workt, no_ownert, obeset, underweightt)
...
totanx<-table(newlongc40$lowpa[newlongc40$medanx=="yes"])[[1]]
peranx<-round(100*prop.table(table(newlongc40$lowpa[newlongc40$medanx=="yes"])))[[1]]

totnoanx<-table(newlongc40$lowpa[newlongc40$medanx=="no"])[[1]]
pernoanx<-round(100*prop.table(table(newlongc40$lowpa[newlongc40$medanx=="no"])))[[1]]
...
names(lowpat)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
                 "pvalue")

all<-rbind(sext,youngert, oldert,low_educationt,low_incomet,no_workt, no_ownert, obeset, underweightt, lowpat)
...
totanx<-table(newlongc40$smoker[newlongc40$medanx=="yes"])[[2]]
peranx<-round(100*prop.table(table(newlongc40$smoker[newlongc40$medanx=="yes"])))[[2]]

totnoanx<-table(newlongc40$smoker[newlongc40$medanx=="no"])[[2]]
pernoanx<-round(100*prop.table(table(newlongc40$smoker[newlongc40$medanx=="no"])))[[2]]
...
names(smokert)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
                  "pvalue")

all<-rbind(sext,youngert, oldert,low_educationt,low_incomet,no_workt, no_ownert, obeset, underweightt, lowpat,smokert)
...
totanx<-table(newlongc40$agroup[newlongc40$medanx=="yes"])[[1]]
peranx<-round(100*prop.table(table(newlongc40$agroup[newlongc40$medanx=="yes"])))[[1]]

totnoanx<-table(newlongc40$agroup[newlongc40$medanx=="no"])[[1]]
pernoanx<-round(100*prop.table(table(newlongc40$agroup[newlongc40$medanx=="no"])))[[1]]
...
names(agroupt)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
                  "pvalue")
...
# 
# totanx<-table(newlongc40$medanx[newlongc40$medanx=="yes"])[[2]]
# peranx<-round(100*prop.table(table(newlongc40$medanx[newlongc40$medanx=="yes"])))[[2]]
# 
# totnoanx<-table(newlongc40$medanx[newlongc40$medanx=="no"])[[2]]
# pernoanx<-round(100*prop.table(table(newlongc40$medanx[newlongc40$medanx=="no"])))[[2]]
# 
...
# names(medanxt)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
#                   "pvalue")
# 
# all<-rbind(sext,youngert, oldert,low_educationt,low_incomet,no_workt, no_ownert, obeset, 
#            underweightt, lowpat,smokert, agroupt,)
...
totanx<-table(newlongc40$diabetes[newlongc40$medanx=="yes"])[[2]]
peranx<-round(100*prop.table(table(newlongc40$diabetes[newlongc40$medanx=="yes"])))[[2]]

totnoanx<-table(newlongc40$diabetes[newlongc40$medanx=="no"])[[2]]
pernoanx<-round(100*prop.table(table(newlongc40$diabetes[newlongc40$medanx=="no"])))[[2]]
...
names(diabetest)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
                    "pvalue")
...
totanx<-table(newlongc40$asthma_mhynmod[newlongc40$medanx=="yes"])[[1]]
peranx<-round(100*prop.table(table(newlongc40$asthma_mhynmod[newlongc40$medanx=="yes"])))[[1]]

totnoanx<-table(newlongc40$asthma_mhynmod[newlongc40$medanx=="no"])[[1]]
pernoanx<-round(100*prop.table(table(newlongc40$asthma_mhynmod[newlongc40$medanx=="no"])))[[1]]
...
names(asthma_mhynmodt)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
                          "pvalue")
...
totanx<-table(newlongc40$multimorb[newlongc40$medanx=="yes"])[[2]]
peranx<-round(100*prop.table(table(newlongc40$multimorb[newlongc40$medanx=="yes"])))[[2]]

totnoanx<-table(newlongc40$multimorb[newlongc40$medanx=="no"])[[2]]
pernoanx<-round(100*prop.table(table(newlongc40$multimorb[newlongc40$medanx=="no"])))[[2]]
...
names(multimorbt)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
                     "pvalue")
...
totanx<-table(newlongc40$weight_loss[newlongc40$medanx=="yes"])[[2]]
peranx<-round(100*prop.table(table(newlongc40$weight_loss[newlongc40$medanx=="yes"])))[[2]]

totnoanx<-table(newlongc40$weight_loss[newlongc40$medanx=="no"])[[2]]
pernoanx<-round(100*prop.table(table(newlongc40$weight_loss[newlongc40$medanx=="no"])))[[2]]
...
names(weight_losst)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
                       "pvalue")
...
(totanx<-table(newlongc40$medcat[newlongc40$medanx=="yes"])[[2]])
(peranx<-round(100*prop.table(table(newlongc40$medcat[newlongc40$medanx=="yes"])))[[2]])

(totnoanx<-table(newlongc40$medcat[newlongc40$medanx=="no"])[[2]])
(pernoanx<-round(100*prop.table(table(newlongc40$medcat[newlongc40$medanx=="no"])))[[2]])

(p<-chisq.test(newlongc40$medcat,newlongc40$medanx))
pvalue<-p$p.value
...
names(medcatt)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
                  "pvalue")
...
(totanx<-table(newlongc40$eyeglass[newlongc40$medanx=="yes"])[[1]])
(peranx<-round(100*prop.table(table(newlongc40$eyeglass[newlongc40$medanx=="yes"])))[[1]])

(totnoanx<-table(newlongc40$eyeglass[newlongc40$medanx=="no"])[[1]])
(pernoanx<-round(100*prop.table(table(newlongc40$eyeglass[newlongc40$medanx=="no"])))[[1]])


(p<-chisq.test(newlongc40$eyeglass,newlongc40$medanx))
pvalue<-p$p.value
...
names(eyeglassat)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
                    "pvalue")
...
(totanx<-table(newlongc40$eyeglass[newlongc40$medanx=="yes"])[[3]])
(peranx<-round(100*prop.table(table(newlongc40$eyeglass[newlongc40$medanx=="yes"])))[[3]])

(totnoanx<-table(newlongc40$eyeglass[newlongc40$medanx=="no"])[[3]])
(pernoanx<-round(100*prop.table(table(newlongc40$eyeglass[newlongc40$medanx=="no"])))[[3]])
...
names(eyeglassst)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
                    "pvalue")
# 
# all<-rbind(sext,aget,low_educationt,low_incomet,no_workt, eyeglassat,eyeglassst,bmit,obeset, 
...
(totanx<-round(mean(newlongc40$score[newlongc40$medanx=="yes"],na.rm=TRUE),1))
(peranx<-round(sd(newlongc40$score[newlongc40$medanx=="yes"],na.rm=TRUE),1))

(totnoanx<-round(mean(newlongc40$score[newlongc40$medanx=="no"],na.rm=TRUE),1))
(pernoanx<-round(sd(newlongc40$score[newlongc40$medanx=="no"],na.rm=TRUE),1))
...
names(scoret)<-c("var","totall","perall","totanx","peranx","totnoanx","pernoanx",
               "pvalue")


all<-rbind(sext,aget,oldert,low_educationt,low_incomet,no_workt, eyeglassat,eyeglassst,bmit,obeset, underweightt,
           phactivityt, lowpat,smokert, agroupt, diabetest, 
           multimorbt, weight_losst,medcatt, scoret)



write.csv(all,"P:/Documents/COVID19/PREDICOVID/symptom_score/generated_data/table1.csv",row.names = FALSE)
